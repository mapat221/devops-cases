...
Начинаю с пункта 7, все предыдущие страдания описаны [здесь](https://github.com/inview-club/devops-cases/tree/main/01-build-isolation/solutions/egerius)

### Удаление ранее загруженного Docker-образа с Nexus
